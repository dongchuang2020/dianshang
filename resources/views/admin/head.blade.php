...
<head>
    ...
    <script src="/front/plugins/jQueryUI/jquery-ui.min.js"></script>
    <script src="/front/plugins/bootstrap/js/bootstrap.min.js"></script>

    <script src="/front/plugins/adminLTE/js/app.min.js"></script>
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/front/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                团队消息
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/front/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
