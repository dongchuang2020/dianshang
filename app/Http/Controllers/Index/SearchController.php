...
class SearchController extends Controller
{
    ...
    public function search($id)
    {
        ...
        $search_show = DB::table('goods')->leftjoin('shop_brand','goods.brand_id','=','shop_brand.brand_id')->leftjoin('shop_category','goods.cate_id','=','shop_category.cate_id')->where('goods.cate_id',$id)->get();
//         dd($search_show);
